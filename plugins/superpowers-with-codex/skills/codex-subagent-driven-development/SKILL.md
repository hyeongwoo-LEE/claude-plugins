...
- **superpowers-with-codex:c-using-git-worktrees** — REQUIRED: Set up isolated workspace before starting
- **superpowers-with-codex:c-writing-plans** — Creates the plan this skill executes
- **superpowers-with-codex:c-requesting-code-review** — Code review template for reviewer subagents
...
- **superpowers-with-codex:c-test-driven-development** — Subagents follow TDD for each task
